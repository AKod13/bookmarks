...
b11 = Book.create(title: "Assasins apprentice", author: "Robin Hobb", description: "Rise of royal bastart to the rank of assasin.", publisher: "LUMEN", weeks_on_list: 1, rank_this_week: 11)
b12 = Book.create(title: "American Gods", author: "Neil Gaiman", description: "Old gods vs new ones", publisher: "Algoritam", weeks_on_list: 3, rank_this_week: 12)
...
Review.create(comment: "Super.", author: "Kodzo", book_id: b11.id)
Review.create(comment: "Top!!! Kodzo must read this!.", author: "Sonja", book_id: b11.id)

Review.create(comment: "Best book ever, Sonja needs to give it another chance.", author: "Kodzo", book_id: b12.id)
Review.create(comment: "I might read it, Kodzo calm down! :).", author: "Sonja", book_id: b12.id)
